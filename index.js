...
client.once(Events.ClientReady, async (readyClient) => {
    ...
    setTimeout(run,
        globalResponse[0].timestamp - new Date().getTime() - (3 * 60 * 1000000) > 0 ? globalResponse[0].timestamp - new Date().getTime() - (3 * 60 * 1000) : 1 // this should notify ALWAYS areound 3 minutes before the event? Is this correct
    );
});
